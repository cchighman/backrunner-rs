...
mod ierc20_mod {
    ...
    impl<M: Middleware> std::fmt::Debug for IERC20<M> {
    ...
    impl From<AllowanceCall> for IERC20Calls {
        fn from(var: AllowanceCall) -> Self {
            IERC20Calls::Allowance(var)
        }
    }

    impl From<ApproveCall> for IERC20Calls {
        fn from(var: ApproveCall) -> Self {
            IERC20Calls::Approve(var)
        }
    }

    impl From<BalanceOfCall> for IERC20Calls {
        fn from(var: BalanceOfCall) -> Self {
            IERC20Calls::BalanceOf(var)
        }
    }

    impl From<TotalSupplyCall> for IERC20Calls {
        fn from(var: TotalSupplyCall) -> Self {
            IERC20Calls::TotalSupply(var)
        }
    }

    impl From<TransferCall> for IERC20Calls {
        fn from(var: TransferCall) -> Self {
            IERC20Calls::Transfer(var)
        }
    }

    impl From<TransferFromCall> for IERC20Calls {
