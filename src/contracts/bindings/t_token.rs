...
mod ttoken_mod {
    ...
    #[doc = "TToken was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<'a, M: ethers::providers::Middleware> TToken<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            let contract =
                ethers::contract::Contract::new(address.into(), TTOKEN_ABI.clone(), client);
            Self(contract)
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, TTokenEvents> {
    ...
    impl ethers::contract::EthLogDecode for TTokenEvents {
            ...
            Self: Sized,
        {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(TTokenEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(TTokenEvents::TransferFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for TTokenEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                TTokenEvents::ApprovalFilter(element) => element.fmt(f),
                TTokenEvents::TransferFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for TTokenCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(TTokenCalls::Allowance(decoded));
            }
            if let Ok(decoded) =
                <ApproveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::Approve(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::BalanceOf(decoded));
            }
            if let Ok(decoded) =
                <DecimalsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::Decimals(decoded));
            }
            if let Ok(decoded) =
                <DecreaseAllowanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::DecreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <IncreaseAllowanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::IncreaseAllowance(decoded));
            }
            if let Ok(decoded) = <NameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(TTokenCalls::Name(decoded));
            }
            if let Ok(decoded) = <SymbolCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::Symbol(decoded));
            }
            if let Ok(decoded) =
                <TotalSupplyCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::TotalSupply(decoded));
            }
            if let Ok(decoded) =
                <TransferCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::Transfer(decoded));
            }
            if let Ok(decoded) =
                <TransferFromCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(TTokenCalls::TransferFrom(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for TTokenCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                TTokenCalls::Allowance(element) => element.encode(),
                TTokenCalls::Approve(element) => element.encode(),
                TTokenCalls::BalanceOf(element) => element.encode(),
                TTokenCalls::Decimals(element) => element.encode(),
                TTokenCalls::DecreaseAllowance(element) => element.encode(),
                TTokenCalls::IncreaseAllowance(element) => element.encode(),
                TTokenCalls::Name(element) => element.encode(),
                TTokenCalls::Symbol(element) => element.encode(),
                TTokenCalls::TotalSupply(element) => element.encode(),
                TTokenCalls::Transfer(element) => element.encode(),
                TTokenCalls::TransferFrom(element) => element.encode(),
            }
        }
    }
    ...
    impl ::std::fmt::Display for TTokenCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                TTokenCalls::Allowance(element) => element.fmt(f),
                TTokenCalls::Approve(element) => element.fmt(f),
                TTokenCalls::BalanceOf(element) => element.fmt(f),
                TTokenCalls::Decimals(element) => element.fmt(f),
                TTokenCalls::DecreaseAllowance(element) => element.fmt(f),
                TTokenCalls::IncreaseAllowance(element) => element.fmt(f),
                TTokenCalls::Name(element) => element.fmt(f),
                TTokenCalls::Symbol(element) => element.fmt(f),
                TTokenCalls::TotalSupply(element) => element.fmt(f),
                TTokenCalls::Transfer(element) => element.fmt(f),
                TTokenCalls::TransferFrom(element) => element.fmt(f),
            }
        }
    }
