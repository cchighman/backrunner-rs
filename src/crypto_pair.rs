...
impl CryptoPair {
    ...
    */
    ...
    pub fn get_amount_out(&self, token_in: Address, amount_in: U256) -> Option<(U256, Address)> {
    ...
    pub fn get_amount_in(&self, token_out: Address, amount_out: U256) -> Option<(U256, Address)> {
