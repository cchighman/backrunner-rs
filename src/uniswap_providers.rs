...
pub static flashbots_client: Lazy<Arc<SignerMiddleware<FlashbotsMiddleware<Provider<Http>, Wallet<SigningKey>>, Wallet<SigningKey>>>> = Lazy::new(|| Arc::new(SignerMiddleware::new(
...
pub static flashbots_bundle_signer: Lazy<Wallet<SigningKey>> = Lazy::new(|| private_key.parse::<LocalWallet>().unwrap().with_chain_id(1u64));
...
pub static from: Lazy<Address> = Lazy::new(|| Address::from_str("0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D").unwrap());
