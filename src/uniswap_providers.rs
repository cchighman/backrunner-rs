    ...
    impl UniswapProviders {
            ...
            let mainnet_provider = 
                Provider::<Http>::try_from("https://mainnet.infura.io/v3/20ca45667c5d4fa6b259b9a36babe5c3").unwrap();
...
//pub fn new(inner: M, relay_url: impl Into<Url>, relay_signer: S) -> Self {
            ...
            Self {
                ...
                MAINNET_BOT_SIGNER: mainnet_bot_signer.clone(),
                MAINNET_BUNDLE_SIGNER: mainnet_bundle_signer.clone(),
