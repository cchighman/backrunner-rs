...
pub async fn flash_swap_v2(
    ...
    let pair_contract = UniswapV2Pair::new(pair_id, Arc::new(*UNISWAP_PROVIDERS.MAINNET_ETH_CLIENT.clone()));

    let contract_call = pair_contract.swap(in_amt, out_amt, *UNISWAP_PROVIDERS.CONTRACT_ADDRESS, calldata);
